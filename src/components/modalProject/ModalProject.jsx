...
const ModalProject = ({ closeModal, content }) => {
  ...
  return (
    <div
      data-aos="zoom-out"
      className="absolute inset-x-0 inset-y-10 z-50 flex h-full w-full items-center justify-center bg-blue-background bg-opacity-70 text-hello-gray  lg:inset-0 "
    >
